...
# endif
            ...
            CASE ('TNU2')
              ...
              DO ng=1,Ngrids
                DO itrc=1,NBT
                  i=idbio(itrc)
                  nl_tnu2(i,ng)=Rbio(itrc+(ng-1)*NBT)
                  nl_tnu2(i,ng)=0.1
                  tnu2(i,ng)=0.1
                END DO
              END DO
            CASE ('TNU4')
              ...
              DO ng=1,Ngrids
                DO itrc=1,NBT
                  i=idbio(itrc)
                  nl_tnu4(i,ng)=Rbio(itrc+(ng-1)*NBT)
                END DO
              END DO
            CASE ('ad_TNU2')
              Npts=load_r(Nval, Rval, NBT*Ngrids, Rbio)
              DO ng=1,Ngrids
                DO itrc=1,NBT
                  i=idbio(itrc)
                  ad_tnu2(i,ng)=Rbio(itrc+(ng-1)*NBT)
                  tl_tnu2(i,ng)=Rbio(itrc+(ng-1)*NBT)
                END DO
              END DO
            CASE ('ad_TNU4')
              Npts=load_r(Nval, Rval, NBT*Ngrids, Rbio)
              DO ng=1,Ngrids
                DO itrc=1,NBT
                  i=idbio(itrc)
                  ad_tnu4(i,ng)=Rbio(itrc+(ng-1)*NBT)
                  tl_tnu4(i,ng)=Rbio(itrc+(ng-1)*NBT)
                END DO
              END DO
            CASE ('LtracerSponge')
              ...
              DO ng=1,Ngrids
                DO itrc=1,NBT
                  i=idbio(itrc)
                  LtracerSponge(i,ng)=Ltrc(itrc+(ng-1)*NBT)
                END DO
              END DO
            CASE ('AKT_BAK')
              Npts=load_r(Nval, Rval, NBT*Ngrids, Rbio)
              DO ng=1,Ngrids
                DO itrc=1,NBT
                  i=idbio(itrc)
                  Akt_bak(i,ng)=Rbio(itrc+(ng-1)*NBT)
                END DO
              END DO
            CASE ('TNUDG')
              Npts=load_r(Nval, Rval, NBT*Ngrids, Rbio)
     ...
     &                      Vname(1,idTvar(idbio(itracer))), LBC)
            ...
            CASE ('LtracerSrc')
              ...
              DO ng=1,Ngrids
                DO itrc=1,NBT
                  i=idbio(itrc)
                  LtracerSrc(i,ng)=Ltrc(itrc+(ng-1)*NBT)
                END DO
              END DO
            ...
            CASE ('LtracerCLM')
              ...
              DO ng=1,Ngrids
                DO itrc=1,NBT
                  i=idbio(itrc)
                  LtracerCLM(i,ng)=Ltrc(itrc+(ng-1)*NBT)
                END DO
              END DO
            CASE ('LnudgeTCLM')
              Npts=load_l(Nval, Cval, NBT*Ngrids, Ltrc)
              DO ng=1,Ngrids
                DO itrc=1,NBT
                  i=idbio(itrc)
                  LnudgeTCLM(i,ng)=Ltrc(itrc+(ng-1)*NBT)
                END DO
              END DO
            CASE ('Hout(idTvar)')
              Npts=load_l(Nval, Cval, NBT*Ngrids, Ltrc)
...
# if defined DIAGNOSTICS_BIO
       ...
       &                      'iDbio2(', itrc, ')'
                    ...
                    RETURN
                  END IF
                  Dout(i,ng)=Lbio2d(itrc+(ng-1)*NBT)
                END DO
              END DO
            CASE ('Dout(iDbio3)')
       ...
       &                      'iDbio3(', itrc, ')'
                    ...
                    RETURN
                  END IF
                  Dout(i,ng)=Lbio3d(itrc+(ng-1)*NBT)
                END DO
              END DO
# endif
          END SELECT
